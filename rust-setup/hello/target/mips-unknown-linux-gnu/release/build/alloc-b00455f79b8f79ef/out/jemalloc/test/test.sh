...
for t in $@; do
  ...
  echo "=== ${t} ==="
  ${t} /home/ravitejareddy/Desktop/HomeNextGen/rust-setup/rust/src/jemalloc/ /home/ravitejareddy/Desktop/HomeNextGen/rust-setup/hello/target/mips-unknown-linux-gnu/release/build/alloc-b00455f79b8f79ef/out/jemalloc/
  result_code=$?
  case ${result_code} in
    ${pass_code})
